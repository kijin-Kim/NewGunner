...
void ULagCompComponent::AuthBeginRewind(float TimeStamp)
{
	if (CharacterOwner->HasAuthority())
	{
...
void ULagCompComponent::AuthEndRewind()
{
...
void ULagCompComponent::AuthSpawnDummyMesh(const FMyPoseSnapshot& NearestFutureSnapshot, const FMyPoseSnapshot& NearestPastSnapshot, float TargetTime)
{
	if (CharacterOwner->HasAuthority())
	{
